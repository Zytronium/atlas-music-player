...
export default function PlayControls() {
  return (
    <div className="flex flex-row justify-between w-full mb-4">
      <button className="cursor-pointer flex h-12 w-12 items-center justify-center">
        <span className="text-lg text-slate-800">1x</span>
      </button>
      <button disabled className="flex h-12 w-12 items-center justify-center">
        <Rewind className="fill-black text-transparent opacity-50" />
      </button>
      <button className="cursor-pointer flex h-12 w-12 items-center justify-center rounded border-black outline-3">
